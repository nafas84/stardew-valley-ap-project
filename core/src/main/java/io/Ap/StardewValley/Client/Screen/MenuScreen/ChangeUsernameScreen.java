...
//        backgroundTexture = new Texture(Gdx.files.internal("etc/menu/background_night.png"));
    ...
    public void show() {
        ...
        Label titleLabel = new Label("Change Username", skin, "Bold");
        ...
        contentTable.add(new Label("new username:", skin)).right().pad(15, 5, 15, 55);
        contentTable.add(username).width(350).left().pad(15, 45, 15, 5);
        contentTable.row();
        ...
        submitButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                Result result;
                try {
                    result = ProfileMenuController.changeUsernameThroughScreen(username.getText());
                } catch (Exception e) {
