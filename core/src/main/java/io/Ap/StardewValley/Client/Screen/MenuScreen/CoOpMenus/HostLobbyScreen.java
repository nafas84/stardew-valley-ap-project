...
public class HostLobbyScreen implements Screen {
    ...
    public HostLobbyScreen(String lobbyName) {
    ...
    public void show() {
        ...
        backButton.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                Result result = ClientLobbyController.hostLeaveLobby(lobbyName);
        ...
        Label titleLabel = new Label("\"" + lobbyName + "\" Host Game Lobby", StardewValley.getSkin(), "Bold");
