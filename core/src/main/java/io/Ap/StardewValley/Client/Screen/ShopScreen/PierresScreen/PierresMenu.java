package io.Ap.StardewValley.Client.Screen.ShopScreen.PierresScreen;
...
public class PierresMenu extends Stage {
    ...
    String texturePath = "shop/Pierre.png";
    ...
    public PierresMenu() {
        ...
        firstMenu = new FirstMenu(skin, "Pierre's store", shopMenuButton, leaveButton);
        firstMenu.setPosition((getViewport().getScreenWidth() - 1050) / 2f, 100);
        firstMenu.setVisible(true);
        this.addActor(firstMenu);

        shopMenu = new ShopMenu(skin, pierresStore, texturePath, this);
