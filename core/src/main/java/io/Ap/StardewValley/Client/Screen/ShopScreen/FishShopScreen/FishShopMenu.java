package io.Ap.StardewValley.Client.Screen.ShopScreen.FishShopScreen;
...
public class FishShopMenu extends Stage {
    ...
    String texturePath = "shop/Willy.png";
    ...
    public FishShopMenu() {
        ...
        firstMenu = new FirstMenu(skin, "Fish shop", shopMenuButton, leaveButton);
